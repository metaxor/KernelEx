...
/*** AUTOGENERATED APILIST NAMED EXPORTS BEGIN ***/
	...
	DECL_API("AttachConsole", AttachConsole_new),
	DECL_API("CompareStringW", CompareStringW_new),
	DECL_API("ConnectNamedPipe", ConnectNamedPipe_new),
	...
	DECL_API("DecodePointer", XorPointerProcess),
	...
	DECL_API("DisconnectNamedPipe", DisconnectNamedPipe_new),
	...
	DECL_API("FindFirstVolumeA", FindFirstVolumeA_new),
	DECL_API("FindFirstVolumeW", FindFirstVolumeW_new),
	DECL_API("FindNextFileW", FindNextFileW_new),
	DECL_API("FindNextVolumeA", FindNextVolumeA_new),
	DECL_API("FindNextVolumeW", FindNextVolumeW_new),
	DECL_API("FindResourceExW", FindResourceExW_new),
	DECL_API("FindResourceW", FindResourceW_new),
	DECL_API("FindVolumeClose", FindVolumeClose_new),
	...
	DECL_API("GetModuleFileNameExA", GetModuleFileNameExA_new),
	DECL_API("GetModuleFileNameExW", GetModuleFileNameExW_new),
	...
	DECL_API("GetProcessIdOfThread", GetProcessIdOfThread_new),
	DECL_API("GetProcessIoCounters", GetProcessIoCounters_stub),
	DECL_API("GetProcessShutdownParameters", GetProcessShutdownParameters_new),
	...
	DECL_API("GetVolumeNameForVolumeMountPointA", GetVolumeNameForVolumeMountPointA_new),
	DECL_API("GetVolumeNameForVolumeMountPointW", GetVolumeNameForVolumeMountPointW_new),
	DECL_API("GetVolumePathNameA", GetVolumePathNameA_new),
	DECL_API("GetVolumePathNameW", GetVolumePathNameW_new),
	DECL_API("GetVolumePathNamesForVolumeNameA", GetVolumePathNamesForVolumeNameA_new),
	DECL_API("GetVolumePathNamesForVolumeNameW", GetVolumePathNamesForVolumeNameW_new),
	...
	DECL_API("SetProcessShutdownParameters", SetProcessShutdownParameters_new),
