...
#define ReAlloc(x,y) recalloc(x,y)
#define GetTextExtentExPointW(h,s,n,m,f,d,l) GetTextExtentExPointW_lame(h,s,n,m,f,d,l)
#define lstrcpynW(x,y,z) lstrcpynW_new(x,y,z)
#define RegisterClassW(x) RegisterClassW_NEW(x)
#define DefWindowProcW(h,m,w,l) DefWindowProcW_NEW(h,m,w,l)
