...
/*** AUTOGENERATED APILIST NAMED EXPORTS BEGIN ***/
	...
	DECL_API("GetAncestor", GetAncestor_nothunk),
	...
	DECL_API("IsChild", IsChild_nothunk),
	DECL_API("IsDialogMessageW", IsDialogMessageA),
	DECL_API("IsGUIThread", IsGUIThread_new),
	...
	DECL_API("SwitchDesktopWithFade", SwitchDesktopWithFade_new),
