...
# ADD LINK32 kernel32.lib user32.lib advapi32.lib comctl32.lib shell32.lib ..\kexcrt\kexcrt.lib libc.lib /nologo /entry:"entrypoint" /subsystem:windows /machine:I386 /nodefaultlib /out:"../output-i386/Release/verify.exe" /OPT:NOWIN98
...
# ADD LINK32 kernel32.lib user32.lib advapi32.lib comctl32.lib shell32.lib ..\kexcrt\kexcrt.lib libc.lib /nologo /entry:"entrypoint" /subsystem:windows /debug /machine:I386 /nodefaultlib /out:"../output-i386/Debug/verify.exe" /pdbtype:sept /OPT:NOWIN98
# SUBTRACT LINK32 /pdb:none
